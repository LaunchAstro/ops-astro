...
| ------------------------------------------------------------------------------------- | -------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `task.create`                                                                         | `/task/create`                         | `operationId`, `fields`, `parentId?`, `board?`, `boardSection?`, `stateKey?` | `FIELD_VALUE_INVALID` 422 (`fields` not an object, or a value of the wrong type), `SOURCE_SPOOFED` 403 (`source`, `intake_state`), `FIELD_UNKNOWN` 422, `TRANSITION_PROTECTED` 422, `PLACEMENT_IS_DERIVED` 422 (`board_rank` in `fields`; a `boardSection` on a subtask), `NOT_FOUND` 404 (naming `parent`, or `state` for a `stateKey` not installed), `PARENT_TRASHED` 409 |
...
| ---------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `task.comment`                     | `/task/comment`                     | `operationId`, `recordId`, `expectedRevision`, `body`, `audience`, `commentType?` | `SCOPE_NOT_GRANTED` 403, `FIELD_VALUE_INVALID` 422, `AUDIENCE_NOT_PERMITTED` 422 (an external party writing `internal`; the agent prefix writing `client`), `NOT_FOUND` 404, `VERSION_STALE` 409, `DEPENDENCY_NOT_LANDED` 501 where a business has no comment type |
