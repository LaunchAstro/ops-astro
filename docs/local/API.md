...
| `task.create`                                | `parentId`, `board`, `boardSection`      | each a string or `null`, or absent                                         | `refuseMistypedIdentifier`, from `prepareCommand` (`commands/prepare.ts`)                              |
