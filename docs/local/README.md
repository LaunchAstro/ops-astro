...
| Database conformance | `corepack pnpm db:conformance`                                                                                                               | `DATABASE_ADMIN_URL` exported, Docker                  | Runs the named suites and fails a run in which one skipped. [Why one of its jobs is red](../agents/database-conformance.md).                      |
